...
public class Ranger extends Classe{
	...
	private HashMap<Integer, TSndBABDTO> populateMap(){
		...
		valori.put(i++, new TSndBABDTO	(1, 2, 2, 0));
		valori.put(i++, new TSndBABDTO	(2, 3, 3, 0));
		valori.put(i++, new TSndBABDTO	(3, 3, 3, 1));
		valori.put(i++, new TSndBABDTO	(4, 4, 4, 1));
		valori.put(i++, new TSndBABDTO	(5, 4, 4, 1));
		valori.put(i++, new TSndBABDTO	(6, 5, 5, 2));
		valori.put(i++, new TSndBABDTO	(7, 5, 5, 2));
		valori.put(i++, new TSndBABDTO	(8, 6, 6, 2));
		valori.put(i++, new TSndBABDTO	(9, 6, 6, 3));
		valori.put(i++, new TSndBABDTO	(10, 7, 7, 3));
		valori.put(i++, new TSndBABDTO	(11, 7, 7, 3));
		valori.put(i++, new TSndBABDTO	(12, 8, 8, 4));
		valori.put(i++, new TSndBABDTO	(13, 8, 8, 4));
		valori.put(i++, new TSndBABDTO	(14, 9, 9, 4));
		valori.put(i++, new TSndBABDTO	(15, 9, 9, 5));
		valori.put(i++, new TSndBABDTO	(16, 10, 10, 5));
		valori.put(i++, new TSndBABDTO	(17, 10, 10, 5));
		valori.put(i++, new TSndBABDTO	(18, 11, 11, 6));
		valori.put(i++, new TSndBABDTO	(19, 11, 11, 6));
		valori.put(i++, new TSndBABDTO	(20, 12, 12, 6));
		
		return valori;
	}
	
	public Ranger(int liv, Razza razza){
